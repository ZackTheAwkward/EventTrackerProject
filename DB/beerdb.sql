...
INSERT INTO `beer` (`id`, `company`, `name`, `abv`, `type`, `description`, `image_url`) VALUES (3, 'Left Hanf Brewing Co.', 'Milk Stout', 6.0, 'Stout - Milk/Sweet', 'Milk sugar in your stout is like cream in your coffee. Just enough sweetness to keep the dark roast in check. Rich and robust, our classic Milk Stout exhibits notes of dark chocolate, freshly brewed coffee, caramelized sugar and roasted malt.', 'https://lh3.googleusercontent.com/9vUhEsGXILsf_fPdoXlkqf9w4uDeUqP2LsynMMUDKfQSvNMNR7fGBeQloQRGg-NXIm10GgVw6NEwbj8nS55tX97KZ61D6XI=s750');
